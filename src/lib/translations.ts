...
export interface Translations {
  ...
  settings: {
    ...
    companyProfile: {
      ...
      sloganHint: string;
      sloganChars: string;
      sloganEnabled: string;
      sloganEnabledOn: string;
      sloganEnabledOff: string;
      sloganEnabledDesc: string;
      aiSloganLabel: string;
      aiSloganPlaceholder: string;
      aiSloganHint: string;
      aiSloganChars: string;
      brandingMode: string;
      standard: string;
      custom: string;
  ...
  eng: {
    ...
    settings: {
      ...
      companyProfile: {
        ...
        sloganEnabled: 'Show Slogan on Posts',
        sloganEnabledOn: 'On',
        sloganEnabledOff: 'Off',
        sloganEnabledDesc: 'Will appear on posts',
        aiSloganLabel: 'AI Slogan',
        aiSloganPlaceholder: 'e.g., Your Health is Our Priority (in Azerbaijani)',
        aiSloganHint: 'AI will use this slogan when creating posts and add it to the appropriate place',
        aiSloganChars: 'characters',
  ...
  aze: {
    ...
    settings: {
      ...
      companyProfile: {
        ...
        brandingParamsTitle: 'Brend Parametrləri',
        brandingParamsDesc: 'AI ilə yaradılmış şəkillərə avtomatik olaraq şirkət loqosu və sloqan əlavə edin',
        automaticBrandingActive: 'Avtomatik Brend Aktiv',
        automaticBrandingDesc: 'Loqo və sloqan bütün yeni AI ilə yaradılmış şəkillərə avtomatik olaraq əlavə olunacaq',
        brandingRequiresLogo: '⚠️ Brendi aktivləşdirmək üçün loqo yükləməlisiniz. Yuxarıdakı "Şirkət Loqosu" bölməsindən loqo yükləyin.',
        sloganLabel: 'Slogan (İstəyə Bağlı)',
        sloganPlaceholder: 'Məs: Sosial Medianızı Transformasiya Edin',
        sloganHint: 'Şəkillərdə loqonun yanında göstəriləcək mətn',
        sloganChars: 'simvol',
        sloganEnabled: 'Postlarda Slogan Göstər',
        sloganEnabledOn: 'Açıq',
        sloganEnabledOff: 'Bağlı',
        sloganEnabledDesc: 'Postlarda görünəcək',
        aiSloganLabel: 'AI Slogan',
        aiSloganPlaceholder: 'Məs: Sağlamlığınız, bizim prioritetimizdir (Azərbaycanca)',
        aiSloganHint: 'Post yaradanda AI bu sloqana baxacaq və lazımı yerə əlavə edəcək',
        aiSloganChars: 'simvol',
        brandingMode: 'Brend Rejimi',
        standard: 'Standart',
        custom: 'Fərdi',
        standardBrandingParams: 'Standart Brend Parametrləri',
        logoPosition: 'Loqo Mövqeyi:',
        sloganPosition: 'Slogan Mövqeyi:',
        logoSize: 'Loqo Ölçüsü:',
        gradient: 'Qradient:',
        standardModeNote: '✨ Standart rejim: Loqo və sloqan üçün avtomatik qradient örtükləri əlavə olunacaq',
        logoPositionLabel: 'Loqo Mövqeyi',
        logoPositionHint: 'Loqo mövqeyini seçin (qradient örtüklə)',
        sloganPositionLabel: 'Slogan Mövqeyi',
        sloganPositionHint: 'Slogan qradient örtüklə görünəcək',
        logoSizeLabel: 'Loqo Ölçüsü',
        logoSizeSmall: 'Kiçik (2%)',
        logoSizeMedium: 'Orta (13%)',
        logoSizeLarge: 'Böyük (25%)',
        sloganSizeLabel: 'Slogan Ölçüsü',
        sloganSizeSmall: 'Kiçik (2%)',
        sloganSizeMedium: 'Orta (4%)',
        sloganSizeLarge: 'Böyük (8%)',
        gradientEnabled: 'Qradient Örtük',
        gradientColor: 'Qradient Rəngi',
        gradientHeight: 'Qradient Hündürlüyü',
        gradientPosition: 'Qradient Mövqeyi',
        gradientTop: 'Yuxarı',
        gradientBottom: 'Aşağı',
        gradientBoth: 'Hər ikisi',
        logoPositionTopLeft: 'Yuxarı Sol',
        logoPositionTopCenter: 'Yuxarı Mərkəz',
        logoPositionTopRight: 'Yuxarı Sağ',
        logoPositionBottomLeft: 'Aşağı Sol',
        logoPositionBottomCenter: 'Aşağı Mərkəz',
        logoPositionBottomRight: 'Aşağı Sağ',
        sloganPositionTopCenter: 'Yuxarı Mərkəz',
        sloganPositionBottomCenter: 'Aşağı Mərkəz',
        logoPositionStandard: 'Yuxarı Mərkəz (Qradientlə)',
        sloganPositionStandard: 'Aşağı Mərkəz (Qradientlə)',
        logoSizeStandard: 'Şəkil eninin 13%',
        gradientStandard: 'Avtomatik (Brend rəngləri)',
  ...
  rus: {
    ...
    settings: {
      ...
      companyProfile: {
        ...
        sloganEnabled: 'Показывать слоган в постах',
        sloganEnabledOn: 'Вкл',
        sloganEnabledOff: 'Выкл',
        sloganEnabledDesc: 'Будет отображаться в постах',
        aiSloganLabel: 'ИИ Слоган',
        aiSloganPlaceholder: 'Например: Ваше здоровье - наш приоритет (на азербайджанском)',
        aiSloganHint: 'ИИ будет использовать этот слоган при создании постов и добавит его в подходящее место',
        aiSloganChars: 'символов',
